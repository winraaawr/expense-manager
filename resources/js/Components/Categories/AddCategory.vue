<template>
    ...
    <Modal class="absolute" size="lg" v-if="isShownAddCategory" @close="closeAddCategory">
        <template #header>
            <div class="flex items-center text-lg">Add New Category</div>
        </template>
        <template #body>
            <form>
                <!-- content form -->
...
const isShownAddCategory = ref(false);

function closeAddCategory() {
    isShownAddCategory.value = false;
    console.log(isShownAddCategory.value);
}
function showAddCategory() {
    isShownAddCategory.value = true;
    console.log(isShownAddCategory.value);
}
